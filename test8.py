...
class MyFrame1(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                          size=wx.Size(500, 422), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.m_txtTel = wx.StaticText(self.m_panel1, wx.ID_ANY, u"전화 :", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText3 = wx.StaticText(self.m_panel3, wx.ID_ANY, u"거래처 :", wx.DefaultPosition, wx.DefaultSize, 0)
