...
class LoginFrame(wx.Dialog):
    ...
    def loginUI(self):
        ...
        self.m_id = wx.TextCtrl(self.panel, pos=(70, 5), size=(200, -1))
        self.m_pw = wx.TextCtrl(self.panel, pos=(70, 40))
...
class MainFrame(wx.Frame):
    ...
    def onColor(self, e):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            self.SetStatusText("당신이 선택한 색상은 {} 입니다.".format(color.GetColour().Get()))
